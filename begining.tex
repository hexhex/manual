...
\begin{center}
\begin{longtable}{p{0.7cm}  p{2cm} p{0.3cm} p{7.0cm}  } 
%--EXTLEARN
& \multicolumn{3}{l}{\texttt{--extlearn[=none,iobehavior,monotonicity,functionality,}} \\
...
%%%%%%%%%%%%%%%%%%%
& \multicolumn{1}{l}{\texttt{--supportsets}} & & \\
& & &Exploits support sets for evaluation.\\
%%%%%%%%%%%%%%%%%%%
& \multicolumn{1}{l}{\texttt{--evalall}} & & \\
...
%%%%%%%%%%%%%%%%%%%
& \multicolumn{1}{l}{\texttt{--nongroundnogoods}} & & \\
& & &Automatically instantiate learned nonground nogoods.\\
%%%%%%%%%%%%%%%%%%%
& \multicolumn{3}{l}{\texttt{--flpcheck=[explicit,ufs,ufsm,aufs,aufsm,none]}}\\
...
%%%%%%%%%%%%%%%%%%%
& \multicolumn{3}{l}{\texttt{--flpcriterion=[all,head,e,none]}}\\
...
& \multicolumn{3}{l}{\texttt{--ufslearn=[none,reduct,ufs]}}\\
...
%%%%%%%%%%%%%%%%%%%
& \multicolumn{3}{l}{\texttt{--eaevalheuristics=[always,periodic,inputcomplete,}}\\
& \multicolumn{3}{l}{\texttt{eacomplete,post,never}}\\
...
%%%%%%%%%%%%%%%%%%%
& \multicolumn{3}{l}{\texttt{--ufscheckheuristic=[post,max,periodic]}}\\

...
\subsection{Input, Output and Reasoning Options}
...
\begin{center}
\begin{tabular}{  m{1cm}  m{4.7cm} m{6.1cm} } 
 & \texttt{--} & Parse from standard input. \\ 
\texttt{-s} & \texttt{--silent}& Do not display anything than the actual result \\ 
\texttt{-f} & \texttt{--filter=foo[,bar[,...]]} & Only display instances of the specified predicate \\
& \texttt{--nofacts} & Do not output EDB facts.\\

...
reasoners and Web resources) \cite{conflict}. The system is 
...
cycle given \cite{pott}. The integrity constraint $r_{15}$ 
...
%\texttt{--extlearn[=none,iobehavior,monotonicity,functionality,linearity,neg,user,generalize]}

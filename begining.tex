...
\begin{longtable}{p{2.2cm}  p{2.5cm} p{0.7cm} p{6.3cm}  } 
...
\begin{center}
\begin{tabular}{p{2.2cm}  p{2.5cm} p{0.7cm} p{6.3cm}  } 
...
\begin{center}
\begin{longtable}{p{0.7cm}  p{2.2cm} p{0.3cm} p{7.0cm}  } 
%--EXTLEARN
\multicolumn{4}{l}{\texttt{--extlearn[=none,iobehavior,monotonicity,functionality,}} \\

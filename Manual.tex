...
\paragraph{Parameter Values (Input)} As it is introduced in Section~\ref{inputparamtypes} \dlvhex{} supports three different input types (constant, predicate and tuple). In order to access and use input parameters in Python plugin following statement is to be executed:  
\begin{verbatim}

...
\rowprefix{r_5} & \leftimpl   \mathit{not} \ 4 = \mathit{\#count} 
\{ P : \mathit{invite(P)} \}. \\
\end{align*}
\end{exmp}
...
\rowprefix{r_3}& b(1). \\
\\
\rowprefix{r_4}& c(X,Y) \leftimpl a(X), b(Y), X <> Y. \\
\rowprefix{r_5}& d(X,Y) \leftimpl a(X), b(Y), X \neq Y. \\
\rowprefix{r_6}& e(X,Y) \leftimpl a(X), b(Y), X < Y. \\
\rowprefix{r_7}& f(X,Y) \leftimpl a(X), b(Y), X > Y. \\
\rowprefix{r_8}& g(X,Y) \leftimpl a(X), b(Y), X \leq Y. \\
\rowprefix{r_9}& h(X,Y) \leftimpl a(X), b(Y), X \geq Y. \\
...
\rowprefix{r_{10}}& \leftimpl \mathit{node}(X), \mathit{not} \ 
\mathit{reached}(X). \\
\\
...
reached(X). \\
\rowprefix{r_{15}} & \leftimpl node(Y), \mathit{not} \ 
\mathit{reached(Y)}. \\
& \\
...
\\
\rowprefix{r_{14}} & \leftimpl goal(I, V), \mathit{not} \  
\mathit{visit(I, V).} \\
\rowprefix{r_{15}} &  \leftimpl guessPath(I, T, V), 
path(I^{\prime},T,V), X \leq XP. \\
\rowprefix{r_{16}} &  \leftimpl guessPath(I,T,V), \mathit{not} \  
\mathit{clear(V).}\\
\\

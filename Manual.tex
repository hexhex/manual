...
\begin{itemize}
\item To access data of type \verb+CONSTANT+, for input variable \verb+var+, one should write \verb+var.value()+. More details about implementation is available in Example~\ref{constantAsInput}.

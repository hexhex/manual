...
For instance,
$\mathit{at(john,day(10),X)}$ is a function with three arguments: constant $\mathit{john}$,
another function $\mathit{day(12})$ with an integer argument, and variable $X$.
...
Program from Example~\ref{strongSafetyExmp} executes successfully with \texttt{--liberalsafety} option (cf. Section~\ref{sec:commandline}) enabled and outputs:
\begin{align*}
\{ & 

...
\leftaligned{\texttt{\$ \thinspace ./configure}} To enable the Python 
...
\leftaligned{\texttt{\$ \thinspace make}} To allow using of multiple 
cores one should specify the \texttt{-jN} option to make 
use of N cores. Finally, the following
\leftaligned{\texttt{\$ \thinspace make install}} installs the package 
...
follows:
\leftaligned{\texttt{\$ \thinspace git clone 
...
\leftaligned{\texttt{\$ \thinspace dlvhex2 program.hex}} where 
...
\end{align*}
\end{exmp}
Complete \hex-program, Python plugin and data file can be downloaded from the following location: \examplelink{example_2_1}.
...
(Y,P), X \noteq Y, \mathit{marrie}d(X,Y). \thinspace [1@2, X,Y,P]\\
\rowprefix{r_9}& : \sim member(X,P), member(Y,P), X \noteq Y, 
same\_skill(X,Y). \thinspace \\ & \hspace{8.92cm} [1@2, X,Y,P] 
\end{align*}
\end{exmp}
This time we have two best 
models in our solution (program to run with \texttt{--weak-allmodels} option enabled):
\begin{align*}
\{ & \mathit{member}(b,p2), \mathit{member}(c,p2), 
   \mathit{member}(a,p1), \mathit{member}(d,p2), 
   \mathit{member}(e,p1) \} \\
   & \mathit{Cost} [ \mathit{Weight:Level]}):  \langle 
   [6:1],[0:2] \rangle \\ 
\{ & \mathit{member}(a,p2), \mathit{member}(b,p1), 
   \mathit{member}(c,p1), \mathit{member}(d,p1), 
   \mathit{member}(e,p2) \} \\
   & \mathit{Cost} ([ \mathit{Weight:Level]}):\langle 
   [6:1],[0:2] \rangle
\end{align*}
...
\end{align*}
\end{exmp}
Python plugins for the example above can be downloaded from the following location: \examplelink{example_3_14}.
...
\end{align*}
\end{exmp}
Complete \hex-program and Python plugin can be downloaded from the following location: \examplelink{example_4_2}.
...
\end{align*}
\end{exmp}
Complete \hex-program, Python plugin and data file can be downloaded from the following location: \examplelink{example_4_2}.
...
\end{align*}
\end{exmp}
Complete \hex-program, Python plugin and data file can be downloaded from the following location: \examplelink{example_4_3}.

...
\rowprefix{r_7}& : \sim TODO \mathit{member}(X,P), \mathit{member}
(Y,P), X \noteq Y, \nott \thinspace \mathit{know(X,Y)}.& 
[1:1] \\
\rowprefix{r_8}& : \sim TODO  \mathit{member}(X,P), \mathit{member}
(Y,P), X \noteq Y, \mathit{marrie}d(X,Y). & [1:2]\\
\rowprefix{r_9}& : \sim TODO member(X,P), member(Y,P), X \noteq Y, 
same\_skill(X,Y). & [1:2] 
\end{align*}
\end{exmp}

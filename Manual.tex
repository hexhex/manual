...
\leftimpl \mathit{cityOfDegree(\_, Deg, F1, \_)}, \\ \qquad 
...
V)}, \mathit{guessPath(I, TP, U)}, \\ & \ext{check}{U, 
...
\begin{align*}
\{ & \mathit{mbr}(a,p2), \mathit{mbr}(b,p1), 
   \mathit{mbr}(c,p1), \mathit{mbr}(d,p2), 
   \mathit{mbr}(e,p2) \} \\
   & \mathit{Cost} [ \mathit{Weight:Level]}):  \langle 
   [6:1],[0:2] \rangle \\ 
\{ & \mathit{mbr}(a,p1), \mathit{mbr}(b,p2), 
   \mathit{mbr}(c,p2), \mathit{mbr}(d,p1), 
   \mathit{mbr}(e,p1) \} \\
   & \mathit{Cost} ([ \mathit{Weight:Level]}):\langle 
   [6:1],[0:2] \rangle
\end{align*}
...
\rowprefix{r_{10}} & guessPath(I,0,V) \leftimpl start(I,V). \\
\rowprefix{r_{11}} &  \mathit{guessPath(I, TP, U)} \vee 
\mathit{nguessPath(I, TP, U)} \leftimpl 
